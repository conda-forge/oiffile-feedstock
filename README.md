...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oiffile-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15370&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oiffile-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oiffile` can be installed with:

```
conda install oiffile
```

It is possible to list all of the versions of `oiffile` available on your platform with:
